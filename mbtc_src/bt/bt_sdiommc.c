...
#define SD8887_A2_BT_FW_NAME "nxp/sd8887_bt_a2.bin"
#define DEFAULT_FW_NAME "nxp/sd8887_uapsta.bin"
#define DEFAULT_BT_FW_NAME "nxp/sd8887_bt_a2.bin"
...
static const struct sdio_device_id bt_ids[] = {
	{SDIO_DEVICE(NXP_VENDOR_ID, SD_DEVICE_ID_8887_BT_FN2)},
	{}
};
...
#define INIT_START_REG  0xA0
#define INIT_END_REG    0xA5
...
bt_dump_sdio_regs(bt_private *priv)
{
	...
	u8 index = 0;
	unsigned int reg_table[] = { 0x58, 0x59, 0x5c, 0x60, 0x64, 0x70,
